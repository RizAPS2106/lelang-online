<div class="container-fluid">
	...
	<form id="update_form" method="post">
		...
		<div class="form-group row">
			<div class="col">
				<input id="update_url" type="hidden" value="<?php echo base_url('petugas/profil_ptg/update_profil'); ?>">
				<input id="update" class="btn btn-warning" type="submit" value="Ubah">
				<?php echo anchor('petugas/dashboard_ptg','<button type="button" class="btn btn-secondary">Kembali</button>'); ?>
			</div>
		</div>
