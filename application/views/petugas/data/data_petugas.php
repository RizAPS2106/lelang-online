			...
			<tr>
				...
				<td>
					...
					<?php if ($ptg->id_petugas != $id_petugas) { ?>
							<a href="<?php echo base_url('petugas/data/hapus_petugas/'.$ptg->id_petugas) ?>" onclick="javascript: return confirm('Yakin akan dihapus?')"><div class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></div></a>
					<?php }else{ ?>
	      ...
	      <form id="input_form" method="post">
	        ...
	        <div class="modal-body">
	        	...
	        	<div class="modal-footer mt-3">
	        		<input id="input_url" type="hidden" value="<?php echo base_url('petugas/data/tambah_petugas') ?>">
	      ...
	      <form id="update_form" method="post">
	      	...
	      	<div class="modal-body">
	        	...
	        	<div class="modal-footer mt-2 ">
	        		<input id="update_url" type="hidden" value="<?php echo base_url('petugas/data/ubah_petugas') ?>">
