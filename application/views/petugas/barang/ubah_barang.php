	...
	<form id="update_form" method="post" enctype="multipart/form-data">
		...
		<div class="form-group row">
			...
			<div class="col-sm-5 mt-3"> 
				<input id="update_url" type="hidden" value="<?php echo base_url('petugas/lelang_barang/update_barang') ?>">
				<button id="update" type="submit" class="btn btn-warning">Ubah Data Barang</button>
				<?php echo anchor('petugas/lelang_barang/index','<button type="button" class="btn btn-secondary">Kembali</button>'); ?>
			</div>
		</div>
