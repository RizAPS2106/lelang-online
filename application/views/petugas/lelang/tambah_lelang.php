<div class="container-fluid">
	...
	<form id="input_form" method="post">
		...
		<div class="form-group row">
			<div class="col"> 
				<input id="input_url" type="hidden" value="<?php echo base_url('petugas/lelang_lelang/input_lelang') ?>">
				<input type="submit" class="btn btn-warning" value="Buka Lelang">
				<?php echo anchor('petugas/lelang_lelang/index','<button type="button" class="btn btn-secondary">Kembali</button>'); ?>
			</div>
		</div>
