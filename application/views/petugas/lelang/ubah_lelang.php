	...
	<form id="update_form" method="post">
		...
		<div class="form-group row">
			<div class="col-6">
				...
				<input id="update_url" type="hidden" value="<?php echo base_url('petugas/lelang_lelang/update_lelang') ?>">
				<input id="update" type="submit" class="btn btn-warning mt-3" value="Ubah">
				<?php echo anchor('petugas/lelang_lelang/index','<button type="button" class="btn btn-secondary mt-3">Kembali</button>'); ?>   
			</div>
