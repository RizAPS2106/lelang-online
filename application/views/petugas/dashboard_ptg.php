<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-xl-4 mb-4">
            <a href="<?php echo base_url('petugas/dashboard_ptg/report_msy') ?>" class="text-decoration-none">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-dark"><?php echo $jumlah_barang ?></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-auto">
                            <i class="fa fa-archive fa-lg text-dark"></i>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-warning"><?php echo $jumlah_lelang ?></div>
                        </div>
                        <div class="col-auto">
                            <i class="fas fa-gavel fa-lg text-warning"></i>
                        </div>
                    </div>
                </div>
            </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <a href="<?php echo base_url('petugas/dashboard_ptg/report_brg') ?>" type="button" class="btn btn-warning text-dark">Generate Laporan</a>
    ...
    <div class="modal fade" id="modal_filter_brg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="<?php echo base_url('petugas/dashboard_ptg/report_brg') ?>" method="post">
    ...
    <div class="modal fade" id="exampleModalLlg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <a href="<?php echo base_url('petugas/dashboard_ptg/report_llg') ?>" type="button" class="btn btn-warning text-dark">Generate Laporan</a>
    ...
    <div class="modal fade" id="modal_filter_llg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="<?php echo base_url('petugas/dashboard_ptg/report_llg') ?>" method="post">
                <label>Dari Tanggal</label>
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="basic-addon1"><i class="fas fa-calendar"></i></span>
