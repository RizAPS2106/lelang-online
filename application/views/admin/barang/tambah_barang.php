	...
	<form id="input_form" method="post" enctype="multipart/form-data">
		...
		<div class="form-group row">
			...
			<div class="col-sm-5 mt-3"> 
				<input id="input_url" type="hidden" value="<?php echo base_url('admin/lelang_barang/input_barang') ?>">
				...
				<?php echo anchor('admin/lelang_barang/index','<button type="button" class="btn btn-secondary">Kembali</button>'); ?>
			</div>
		</div>
