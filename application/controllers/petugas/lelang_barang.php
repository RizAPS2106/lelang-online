...
class Lelang_barang extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('petugas/barang/lelang_barang',$data);
	...
	public function tambah_barang()
	{
		$this->load->view('templates_ptg/header');
		$this->load->view('templates_ptg/navbar');
		$this->load->view('petugas/barang/tambah_barang');
		$this->load->view('templates_ptg/footer');
	}
	...
	public function detail_barang($id_barang)
	{
		...
		$this->load->view('templates_ptg/header');
		$this->load->view('templates_ptg/navbar');
		$this->load->view('petugas/barang/detail_barang',$data);
		$this->load->view('templates_ptg/footer');
	}
	...
	public function ubah_barang($id_barang)
	{
		...
		$this->load->view('templates_ptg/header');
		$this->load->view('templates_ptg/navbar');
		$this->load->view('petugas/barang/ubah_barang',$data);
		$this->load->view('templates_ptg/footer');
	}
	...
	public function hapus_barang($id_barang)
	{
		...
		redirect('petugas/lelang_barang/index');
	}
