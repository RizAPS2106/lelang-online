...
class Lelang_lelang extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('petugas/lelang/lelang_lelang',$data);
	...
	public function tambah_lelang()
	{
		...
		$this->load->view('templates_ptg/header');
		$this->load->view('templates_ptg/navbar');
		$this->load->view('petugas/lelang/tambah_lelang',$data);
		$this->load->view('templates_ptg/footer');
	}
	...
	{	
		...
		$this->load->view('templates_ptg/header');
		$this->load->view('templates_ptg/navbar');
		$this->load->view('petugas/lelang/detail_lelang',$data);
		$this->load->view('templates_ptg/footer');
	}
	...
	public function ubah_lelang($id_lelang)
	{
		...
		$this->load->view('templates_ptg/header');
		$this->load->view('templates_ptg/navbar');
		$this->load->view('petugas/lelang/ubah_lelang',$data);
		$this->load->view('templates_ptg/footer');
	}
	...
	public function hapus_lelang($id_lelang)
	{
		...
		redirect('petugas/lelang_lelang/index');
	}
