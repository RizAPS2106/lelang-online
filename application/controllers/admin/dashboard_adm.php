...
class Dashboard_adm extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('admin/dashboard_adm',$data);
	...
	public function report_msy()
	{
		...
		$this->load->view('admin/laporan/laporan_masyarakat',$data);
	...
	public function report_ptg()
	{
		...
		$this->load->view('admin/laporan/laporan_petugas',$data);
	...
	public function report_brg()
	{
		...
		$this->load->view('admin/laporan/laporan_barang',$data);
	...
	public function report_llg()
	{
		...
		$this->load->view('admin/laporan/laporan_lelang',$data);
